    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPrizes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookPrizes_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookPrizes_Prizes_PrizeId",
                        column: x => x.PrizeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    LocationId = table.Column<int>(type: "int", nullable: false),
                    SpanishAudio = table.Column<bool>(type: "bit", nullable: false),
                    URL = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePrizes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoviePrizes_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviePrizes_Prizes_PrizeId",
                        column: x => x.PrizeId,
                        principalTable: "Prizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieWishLists_WishLists_WishListId",
                        column: x => x.WishListId,
                        principalTable: "WishLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPrizes_BookId",
                table: "BookPrizes",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookPrizes_PrizeId",
                table: "BookPrizes",
                column: "PrizeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviePrizes_MovieId",
                table: "MoviePrizes",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MoviePrizes_PrizeId",
                table: "MoviePrizes",
                column: "PrizeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieWishLists_WishListId",
                table: "MovieWishLists",
                column: "WishListId");
        }
