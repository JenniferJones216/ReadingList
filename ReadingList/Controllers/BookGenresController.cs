...
namespace ReadingList.Controllers
{
    public class BookGenresController : Controller
    {
        ...
        public BookGenresController(ReadingContext context)
        {
            _context = context;
        }
        ...
        {
            var readingContext = _context.BookGenres.Include(b => b.Book).Include(b => b.Genre);
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,GenreId")] BookGenre bookGenre)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Books, "Id", "Id", bookGenre.BookId);
            ViewData["GenreId"] = new SelectList(_context.Genres, "Id", "Id", bookGenre.GenreId);
            return View(bookGenre);
        }
